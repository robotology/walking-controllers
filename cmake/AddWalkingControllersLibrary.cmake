...
function(add_walking_controllers_library)
  ...
  if(is_interface)
    ...
    install(FILES ${public_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/${PROJECT_NAME}/${installation_folder}")
    install(FILES ${private_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/${PROJECT_NAME}/${installation_folder}/impl")
