...
#ifndef WALKING_TASK_PRIORITY_HPP
#define WALKING_TASK_PRIORITY_HPP
...
public:
    ...
    void setAngularMomentumJacobian(const iDynTree::MatrixDynSize& angularMomentumJacobian);
